...
BSP_FILE=minitx.bsp
BSP_FILE_PATH=minitx
BSP_FILE_URL=https://github.com/FredKellerman/minitx-PYNQ/releases/download/v2.6.0
...
SD_IMAGE_FILE=minitx-2.6.0.img
OVERLAY_FILE_PATH=minitx/base_overlay
OVERLAY_NAME=minitx_base_overlay
START_DIR=$PWD
...
make clean
make PREBUILT="$START_DIR/$ROOTFS_TMP_DIR/$ROOTFS_IMAGE_FILE" BOARDDIR="$BOARDDIR"
